...
## 📌 今週の攻める1個
> **夢AWARD 応募骨子を完成・提出** — 締切 6/7（残**5日**）。7日連続未着手。今日やらないと詰む。

## 🔥 絶対やる（1個）

- [ ] **夢AWARD応募骨子 完成・提出準備** — [[entities/eemus]]
  - 残5日（6/7締切）。叩き台2本：`_promoted/newbiz/eemus-dream-award-骨子v3-2026-05-27.md` + `eemus-dream-award-story-2026-05-31.md`
  - 朝一番・他を全部閉じて30分向き合う。これだけで今日は勝ち。

## 🌱 できれば（2個まで）

- [ ] **AIpaX 5社目クロージング接触** — [[entities/aipax]]
  - 想定問答15選完成済み。大井が1社に連絡するだけ。月収80万ギャップの最速手。
- [ ] **qwen3:8bバグ対処** — [[08_openclaw/README]]
  - BG-Entities系context_filesからooi-yuei.md除外 or qwen3.6:latestに切替。3件破損中。

## ⏳ OpenClaw処理中

> task_board.ps1 が queue/inbox + processing の状況を自動反映

- [ ] **[処理中 1198分]** [School] 親向けLP完全版
- [ ] **[処理中 314分]** [Shincoder S1] 繝槭う繧ｯ繝ｭ繝輔Λ繧ｹ繝医Ξ繝ｼ繧ｷ繝ｧ繝ｳ 10蛟句庶髮・(2026-06-03)
- [ ] [待機] [School] 入学後30日プラン
...
- [x] Phase 1 残務処理: queue 1521件 archive、BrainAutoReview Disabled（5/27 06:00）
- [x] 朝ルーティン完了（5/27 09:00）
- [x] AIpa Web inbox 5件昇格判定（5/27 12:30）
- [x] 昼チェック実行（5/28〜6/1 計5回）
- [x] 夜PDCA（5/31 22:00）: 4件昇格・225件削除
- [x] 昼チェック（6/1 12:30）: 1件昇格・10件削除・qwen3:8bバグ検出
- [x] 昼チェック（6/2 12:30）: 1件昇格・10件削除（Stripe qwen3:8b×4+重複×6）→ [[_routines/midday-20260602]]

## 📅 今日の予定（Calendar）

- 特になし
- ⚠️ 補助金: デジタル化AI導入補助金2026 第2次 6/15締切（残13日）— 今週中に要確認

## 🔍 監視結果（朝08:30 OpenClaw 6/2）

- 競合動向: [[_monitor/competitor-20260602]] — **未生成**（BrainMonitor遅延）
- ビジコン締切: [[_monitor/deadlines-20260602]] — **未生成**
- 朝の問い: [[_monitor/grill-20260602]] — **未生成**
- ★ AI news要点（hot.mdより）: デジタル化AI補助金2026 第2次6/15締切・Anthropic $65B調達・Google Gemini CLI 6/18統合
